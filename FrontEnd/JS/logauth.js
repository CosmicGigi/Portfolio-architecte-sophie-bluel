document.addEventListener('DOMContentLoaded', () => {
    ...
    const editionWorkContainer = document.querySelectorAll('#editionwork i', '#editionwork span');
    ...
    /*if (editionWorkContainer) {
        if (authToken && userRole === 'editionWork i, editionWork span') {
            editionWorkContainer.style.display = 'flex'; // Affiche le mode édition
        } if (!authToken && !userRole) {
            editionWorkContainer.style.display = 'none'; // Cache le mode édition
        }
    }*/
